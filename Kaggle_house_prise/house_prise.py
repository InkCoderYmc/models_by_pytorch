    ...
    for i in range(k):
        ...
        if i == 0:
            semilogy(range(1, num_epochs + 1), train_ls, 'epochs', 'rmse',
                     ...
                     ['train', 'valid'])
        print('fold %d, train rmse %f, valid rmse %f' % (i, train_ls[-2], valid_ls[-1]))
...
train_rmse = train_and_pred(train_features, test_features, train_labels, test_data, num_epochs, lr, weight_decay, batch_size)